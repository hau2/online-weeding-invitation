...
function SidebarUserFooter() {
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      {/* User dropdown */}
      <DropdownMenu>
        <DropdownMenuTrigger className={`flex items-center gap-3 cursor-pointer rounded-lg p-2 hover:bg-[#f4f0f1] transition-colors w-full ${isCollapsed ? 'justify-center' : ''}`}>
